    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_test_food_list).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                foodService.get(LoginActivity.this, "getFoodList.php", params, new Listener() {
                    @Override
                    public void onSuccess(Object object) {
    ...
    private void login(){
        ...
        userService.get(this, url, params, new Listener() {
            ...
            public void onSuccess(Object object) {
                ...
                ToastManager.toast(LoginActivity.this,((UserData)object).getState()+"");
                ...
                if(userModel.getType()==0){
                    ...
                    //启动管理员界面
                    System.err.println("userAcc"+userModel.getAccessKey());
                    Intent intent=new Intent(LoginActivity.this,AdminSelectActivity.class);
                    startActivity(intent);
                }
            ...
            @Override
            public void onFailure(String msg) {
                ToastManager.toast(LoginActivity.this,msg);
            }
        });
